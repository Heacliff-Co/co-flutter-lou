...
import 'package:louhie/core/utils/tuple.dart';
...
class MediaSummaryModel {
  ...
  factory MediaSummaryModel.fromJson(Map<String, dynamic> json) =>
      MediaSummaryModel._(
        id: json['id'] as int,
        title: Pair(
        ...
        description: ((json['description'] as String)
            ...
            : '${(json['description'] as String).split(' ').sublist(0, 20).join(' ').replaceAll(RegExp(r'<[^>]*>'), '')} ...',
